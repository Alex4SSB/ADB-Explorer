...
{
    private const FileToIconConverter.IconSize iconSize = FileToIconConverter.IconSize.Small;
    ...
    private static Icon ExtIcon(string extension, FileToIconConverter.IconSize iconSize, bool isLink, bool isApk = false)
    {
