...
public static class UISettings
{
    ...
    private static List<AbstractSetting> BuildAboutSettings()
    {
        var settings = new List<AbstractSetting>
        {
            ...
            new LinkSetting(Strings.Resources.S_APP_DATA_FOLDER, new(AppDataPath), new(FluentPathGeometries.ItemPath, rtlBehavior: RtlBehavior.ForceLtr), resolveFilePath: () => AppDataPath),
    ...
    public static void Init()
    {
        ...
        [
            ...
            [
                new BoolSetting(() => Settings.EnableApk, Strings.Resources.S_SETTINGS_APK, icon: new(FluentPathGeometries.BoxCheckmark, rtlBehavior: RtlBehavior.ForceLtr)),
