...
public static class AppActions
{
    ...
    public static BaseIcon Icon(FileActionType type, double size = 18) => type switch
    {
        ...
        FileActionType.CompressTo or FileActionType.NewCompressTo => new(new ZipIcon(), size),
    ...
    [
        ...
        new(FileActionType.NewCompressTo,
            () => Data.FileActions.IsCompressToEnabled,
            () => { },
            Strings.Resources.S_MENU_ARCHIVE),
        new(FileActionType.MoreCompress,
            () => Data.FileActions.IsCompressToContextEnabled,
            () => { },
            Strings.Resources.S_MENU_ARCHIVE),
        ...
        new(FileActionType.Install,
            () => Data.FileActions.InstallUninstallEnabled,
